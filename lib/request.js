...
const requestInternal = (request, resolve) => {
    const { type = 'base', method = 'GET', uri, version = 'HTTP/1.1', headers: _headers = {}, body, info, timeout = 30000, follow = false, download = true, correctHeaders = true, rejectUnauthorized = true, ...rest } = request
